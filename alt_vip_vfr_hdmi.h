#ifndef _ALTERA_ALT_VIP_VFR_HDMI_H_
#define _ALTERA_ALT_VIP_VFR_HDMI_H_
...
/*
 * This file contains macros for module 'alt_vip_vfr_hdmi' and devices
...
#endif /* _ALTERA_ALT_VIP_VFR_HDMI_H_ */
