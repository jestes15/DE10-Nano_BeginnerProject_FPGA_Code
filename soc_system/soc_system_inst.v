	soc_system u0 (
		...
		.operand_a_export                      (<connected-to-operand_a_export>),                      //                      operand_a.export
		.operand_b_export                      (<connected-to-operand_b_export>),                      //                      operand_b.export
		.reset_reset_n                         (<connected-to-reset_reset_n>),                         //                          reset.reset_n
		.result_export                         (<connected-to-result_export>)                          //                         result.export
	);
