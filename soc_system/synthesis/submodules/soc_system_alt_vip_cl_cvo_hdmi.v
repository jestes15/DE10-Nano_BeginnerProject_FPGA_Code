// soc_system_alt_vip_cl_cvo_hdmi.v
...
`timescale 1 ps / 1 ps
module soc_system_alt_vip_cl_cvo_hdmi #(
		parameter BPS                           = 8,
		...
		parameter V_BLANK                       = 0,
		parameter H_BLANK                       = 0,
		parameter H_SYNC_LENGTH                 = 32,
		parameter H_FRONT_PORCH                 = 32,
		parameter H_BACK_PORCH                  = 64,
		parameter V_SYNC_LENGTH                 = 3,
		parameter V_FRONT_PORCH                 = 1,
		parameter V_BACK_PORCH                  = 27,
	...
	soc_system_alt_vip_cl_cvo_hdmi_video_in video_in (
	...
	alt_vip_control_slave #(
		...
		.av_mm_control_irq           (status_update_irq_irq),                     // av_mm_control_interrupt.irq
