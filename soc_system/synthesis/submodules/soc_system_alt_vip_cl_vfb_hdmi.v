// soc_system_alt_vip_cl_vfb_hdmi.v
...
`timescale 1 ps / 1 ps
module soc_system_alt_vip_cl_vfb_hdmi #(
		...
		parameter WRITE_BURST_TARGET           = 2,
		parameter READ_FIFO_DEPTH              = 256,
